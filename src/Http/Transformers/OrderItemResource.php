...
class OrderItemResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'vendor'                => $this->product->seller,
            'product_type'          => get_class($this->product),
            'sku'                   => $this->sku,
            'type'                  => $this->type,
            'name'                  => $this->product->descriptions->first()?->product_name,
            'weight'                => $this->weight,
            ...
            'additional'            => array_merge($this->resource->additional ?? [], [
                                        'locale' => core()->getCurrentLocale(),
                                        'EstimateDeliveryDays' => $this->product->delivery_in,
                                        'EstimateDeliveryDate' => core()->getDeliveryDate($this->product->delivery_in),
                                    ]), //Todo
